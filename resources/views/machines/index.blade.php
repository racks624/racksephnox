    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-16">
            <div class="inline-block">
                ...
                <p class="text-sm text-ivory/50 mt-2">Including the new Origin (RX0) – start your journey with as little as KES 200</p>
            </div>
        </div>
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12">
            <div class="card-golden p-4 text-center group hover:scale-105 transition">
                ...
                <p class="text-2xl font-bold text-gold">7</p>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-8">
            ...
            <div class="card-golden p-6 group hover:scale-105 transition-all duration-300 border-t-4 border-gold/50">
                ...
                <!-- VIP Tiers (now uses getVIPAmounts which returns only 3 levels from DB) -->
                ...
                <div class="mt-5 pt-3 border-t border-gold/20 flex justify-between text-xs">
                    ...
                    <span class="text-ivory/50"><i class="fas fa-coins mr-1"></i> KES {{ number_format($machine->getStatistics()['total_invested'] / 1000, 0) }}K</span>
