...
<body class="font-sans antialiased bg-gradient-to-br from-gray-900 via-purple-900 to-gray-900">
    <div class="min-h-screen flex flex-col sm:justify-center items-center pt-6 sm:pt-0">
        <div class="mb-6">
            <a href="{{ route('home') }}">
                <div class="w-20 h-20 bg-gradient-to-r from-gold-400 to-gold-600 rounded-2xl flex items-center justify-center shadow-2xl transform hover:scale-110 transition-all duration-500">
                    <img src="{{ asset('img/logo-racksephnox.svg') }}" alt="Racksephnox" class="h-12 w-auto">
                </div>
            </a>
        </div>

        <div class="w-full sm:max-w-md mt-6 px-6 py-4 bg-gray-800/80 backdrop-blur-xl rounded-2xl shadow-2xl border border-gold/30">
            @yield('content')
        </div>

        <div class="text-center mt-8 text-xs text-gold-500/60">
